...
--
-- Table structure for table `nottingham`
--

DROP TABLE IF EXISTS `nottingham`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `nottingham` (
...
--
-- Dumping data for table `nottingham`
--

LOCK TABLES `nottingham` WRITE;
/*!40000 ALTER TABLE `nottingham` DISABLE KEYS */;
/*!40000 ALTER TABLE `nottingham` ENABLE KEYS */;
UNLOCK TABLES;
