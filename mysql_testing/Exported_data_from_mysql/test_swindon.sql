...
--
-- Table structure for table `swindon`
--

DROP TABLE IF EXISTS `swindon`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `swindon` (
...
--
-- Dumping data for table `swindon`
--

LOCK TABLES `swindon` WRITE;
/*!40000 ALTER TABLE `swindon` DISABLE KEYS */;
/*!40000 ALTER TABLE `swindon` ENABLE KEYS */;
UNLOCK TABLES;
