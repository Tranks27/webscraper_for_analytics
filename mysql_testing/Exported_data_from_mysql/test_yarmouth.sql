...
--
-- Table structure for table `yarmouth`
--

DROP TABLE IF EXISTS `yarmouth`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `yarmouth` (
...
--
-- Dumping data for table `yarmouth`
--

LOCK TABLES `yarmouth` WRITE;
/*!40000 ALTER TABLE `yarmouth` DISABLE KEYS */;
/*!40000 ALTER TABLE `yarmouth` ENABLE KEYS */;
UNLOCK TABLES;
