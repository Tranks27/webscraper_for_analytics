...
--
-- Table structure for table `monmore_bags`
--

DROP TABLE IF EXISTS `monmore_bags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `monmore_bags` (
...
--
-- Dumping data for table `monmore_bags`
--

LOCK TABLES `monmore_bags` WRITE;
/*!40000 ALTER TABLE `monmore_bags` DISABLE KEYS */;
/*!40000 ALTER TABLE `monmore_bags` ENABLE KEYS */;
UNLOCK TABLES;
