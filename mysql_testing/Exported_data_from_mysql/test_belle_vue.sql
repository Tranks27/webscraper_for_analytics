...
--
-- Table structure for table `belle_vue`
--

DROP TABLE IF EXISTS `belle_vue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `belle_vue` (
...
--
-- Dumping data for table `belle_vue`
--

LOCK TABLES `belle_vue` WRITE;
/*!40000 ALTER TABLE `belle_vue` DISABLE KEYS */;
/*!40000 ALTER TABLE `belle_vue` ENABLE KEYS */;
UNLOCK TABLES;
