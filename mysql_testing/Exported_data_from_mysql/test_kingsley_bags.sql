...
--
-- Table structure for table `kingsley_bags`
--

DROP TABLE IF EXISTS `kingsley_bags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kingsley_bags` (
...
--
-- Dumping data for table `kingsley_bags`
--

LOCK TABLES `kingsley_bags` WRITE;
/*!40000 ALTER TABLE `kingsley_bags` DISABLE KEYS */;
/*!40000 ALTER TABLE `kingsley_bags` ENABLE KEYS */;
UNLOCK TABLES;
