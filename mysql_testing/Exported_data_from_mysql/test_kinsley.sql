...
--
-- Table structure for table `kinsley`
--

DROP TABLE IF EXISTS `kinsley`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kinsley` (
...
--
-- Dumping data for table `kinsley`
--

LOCK TABLES `kinsley` WRITE;
/*!40000 ALTER TABLE `kinsley` DISABLE KEYS */;
/*!40000 ALTER TABLE `kinsley` ENABLE KEYS */;
UNLOCK TABLES;
