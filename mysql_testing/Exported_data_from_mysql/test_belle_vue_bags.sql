...
--
-- Table structure for table `belle_vue_bags`
--

DROP TABLE IF EXISTS `belle_vue_bags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `belle_vue_bags` (
...
--
-- Dumping data for table `belle_vue_bags`
--

LOCK TABLES `belle_vue_bags` WRITE;
/*!40000 ALTER TABLE `belle_vue_bags` DISABLE KEYS */;
/*!40000 ALTER TABLE `belle_vue_bags` ENABLE KEYS */;
UNLOCK TABLES;
