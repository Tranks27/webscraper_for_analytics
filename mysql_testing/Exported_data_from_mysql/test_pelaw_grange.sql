...
--
-- Table structure for table `pelaw_grange`
--

DROP TABLE IF EXISTS `pelaw_grange`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pelaw_grange` (
...
--
-- Dumping data for table `pelaw_grange`
--

LOCK TABLES `pelaw_grange` WRITE;
/*!40000 ALTER TABLE `pelaw_grange` DISABLE KEYS */;
/*!40000 ALTER TABLE `pelaw_grange` ENABLE KEYS */;
UNLOCK TABLES;
