...
--
-- Table structure for table `perry_barr`
--

DROP TABLE IF EXISTS `perry_barr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `perry_barr` (
...
--
-- Dumping data for table `perry_barr`
--

LOCK TABLES `perry_barr` WRITE;
/*!40000 ALTER TABLE `perry_barr` DISABLE KEYS */;
/*!40000 ALTER TABLE `perry_barr` ENABLE KEYS */;
UNLOCK TABLES;
