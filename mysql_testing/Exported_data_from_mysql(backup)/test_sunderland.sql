...
--
-- Table structure for table `sunderland`
--

DROP TABLE IF EXISTS `sunderland`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sunderland` (
...
--
-- Dumping data for table `sunderland`
--

LOCK TABLES `sunderland` WRITE;
/*!40000 ALTER TABLE `sunderland` DISABLE KEYS */;
/*!40000 ALTER TABLE `sunderland` ENABLE KEYS */;
UNLOCK TABLES;
