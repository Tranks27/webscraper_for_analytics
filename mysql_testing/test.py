    ...
    with connect(
        ...
        with connection.cursor() as cursor:
            ...
            for starting_row in range(0,80,9):
                ...
                non_abandoned_cnt = races_cnt - abandon_cnt
                print(f'Strategy 1: \n{stra1_cnts}\n')
                print(f'Strategy 2: \n{stra2_cnts}\n')
                print(f'Strategy 3: \n{stra3_cnts}\n')
                # print(f'Strategy 4: \n{stra4_cnts}\n')
                ...
                with open('sigle_venue_strategy_results.csv', 'a+') as f:
                    writer = csv.writer(f)
                    ...
                    if len(data) > 0:
                        ...
                        writer.writerow(['Stra1_1','Stra1_2','Stra1_3','Stra1_4','Stra1_5','Stra1_6',\
